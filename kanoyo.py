...
def cli_infer(com):
    ...
    print("Kanoyo Infer-CLI: Starting the inference...")
    vc_data = vc.get_vc(model_name, protection_amnt, protect1)
    print(vc_data)
    print("Kanoyo Infer-CLI: Performing inference...")
    ...
    if "Success." in conversion_data[0]:
        print("Kanoyo Infer-CLI: Inference succeeded.")
    else:
        print("Kanoyo Infer-CLI: Inference failed. Here's the traceback: ")
...
def cli_extract_feature(com):
    ...
    print("Kanoyo-CLI: Extract Feature Has Pitch: " + str(has_pitch_guidance))
    print("Kanoyo-CLI: Extract Feature Version: " + str(version))
    print("Kanoyo Feature Extraction: Starting...")
    ...
    execute_generator_function(generator)
    print("Kanoyo Feature Extraction: Finished")
...
def cli_train(com):
    ...
    print("Kanoyo Train-CLI: Training...")
    click_train(
        model_name,
        sample_rate,
        has_pitch_guidance,
...
def cli_train_feature(com):
    ...
    model_name = com[0]
    version = com[1]
    print("Kanoyo Train Feature Index-CLI: Training... Please wait")
    generator = train_index(model_name, version)
    execute_generator_function(generator)
    print("Kanoyo Train Feature Index-CLI: Done!")
...
def cli_extract_model(com):
    ...
    if extract_small_model_process == "Success.":
        print("Kanoyo Extract Small Model: Success!")
    else:
        print(str(extract_small_model_process))
        print("Kanoyo Extract Small Model: Failed!")
